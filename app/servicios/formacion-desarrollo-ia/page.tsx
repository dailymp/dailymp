...
export default function FormacionDesarrolloIaPage() {
    ...
    <main className="min-h-screen">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-6 py-20">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/#services" className="px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-semibold transition-all hover:scale-105">{t("discoverMore")}</a>
      ...
      <section id="contact" className="py-20 px-6 border-t border-gray-800">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a href={`mailto:${siteConfig.email}?subject=Formación%20IA%20Consultoría`} className="px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-semibold transition-all hover:scale-105">{t("formacionDesarrolloIaContactCTA")}</a>
        </div>
      </section>
    </main>
  );
