...
Resilient JSON-RPC client handling authentication, errors and CRUD operations over Odoo models (`fleet.vehicle`, `vehicle.rental.agreement`, `vehicle.rental.category`, etc.).
